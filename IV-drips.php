<?php include ('includes/header.php'); ?>
  ...
  <body>
    ...
    <main class="content-sec con-no-pd content-bg" data-aos="">
      ...
      <section class="section-sec discover-sec" id="iv">
        <div class="container-xxl">
          <div class="row">
            <div class="col-12">
                    ...
                    <div class="col-12 col-dis-item">
                      <div class="dis-item-cover">
                        <a href="brain-B-shot.php"
                          ><figure>
                            <img src="images/brain-b.jpg" alt="Image" />
                          </figure>
                    ...
                    <div class="col-12 col-dis-item">
                      <div class="dis-item-cover">
                        <a href="beauty-B-shot.php"
                          ><figure>
                            <img src="images/beauty-b.jpg" alt="Image" />
                          </figure>
                    ...
                    <div class="col-12 col-dis-item">
                      <div class="dis-item-cover">
                        <a href="lean-B-shot.php"
                          ><figure>
                            <img src="images/learn-b.jpg" alt="Image" />
                          </figure>
                    ...
                    <div class="col-12 col-dis-item">
                      <div class="dis-item-cover">
                        <a href="mix-B-complex.php"
                          ><figure>
                            <img src="images/b-complex.jpg" alt="Image" />
                          </figure>
                    ...
                    <div class="col-12 col-dis-item">
                      <div class="dis-item-cover">
                        <a href="vitamin-K-shot.php"
                          ><figure>
                            <img src="images/k-shot.jpg" alt="Image" />
                          </figure>
